<?php
/**
 * This page is for writting messages to other users.
 */
...
//check privilegies
if($login != 'admin'){
	my_die("У вас нет прав для просмотра этой странички");
}
...
//show body
echo"
Выберете получателя (используйте CTRL и/или SHIFT чтобы выбрать больше одного получателя)
<br>
<form method=POST>
